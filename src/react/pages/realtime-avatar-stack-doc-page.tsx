    ...
    <main className="relative lg:gap-10 xl:grid xl:grid-cols-[1fr_200px] px-8 md:px-16 py-20">
      <div className="mx-auto w-full min-w-0 max-w-4xl">
        <div className="mb-4 flex items-center space-x-1 text-sm text-muted-foreground">
          ...
          <div className="text-muted-foreground">Realtime Avatar Stack</div>
        </div>
        ...
        <div className="pb-12">
          <div className="mdx">
            ...
            <ul className="my-6 ml-6 list-disc text-foreground/70">
              <li className="mt-2">
                <a className="text-foreground underline decoration-1 decoration-foreground-muted underline-offset-4 transition-colors hover:decoration-primary hover:decoration-2" href="https://supabase.com/docs/guides/realtime/presence">
                  Realtime Presence
                </a>
              </li>
              <li className="mt-2">
