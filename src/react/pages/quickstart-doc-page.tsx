...
const sections = [
  { id: 'set-up-shadcnui', title: 'Set up shadcn/ui' },
    ...
    <main className="relative lg:gap-10 xl:grid xl:grid-cols-[1fr_200px] px-8 md:px-16 py-20">
      <div className="mx-auto w-full min-w-0 max-w-4xl">
        <div className="mb-4 flex items-center space-x-1 text-sm text-foreground/60">
          ...
          <div className="text-foreground/40">Quick Start</div>
        </div>

        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-5">
          <div className="space-y-2">
            <h1 className="scroll-m-20 text-2xl lg:text-4xl tracking-tight">Quick Start</h1>
        ...
        <div className="pb-12">
          <div className="mdx">
            <h2 className="font-heading mt-12 scroll-m-20 border-b pb-2 text-2xl tracking-tight first:mt-0" id="set-up-shadcnui">
              <SectionLink id="set-up-shadcnui" /> Set up shadcn/ui
            </h2>
            ...
            <p className="leading-7 not-first:mt-6 text-foreground/70">
              If you're already using a recent version of shadcn/ui in your existing project, you can skip this step—this library should work with your current setup. However, if you encounter issues, try deleting your existing{' '}
              <code className="relative rounded-sm bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm">components.json</code>{' '}
              file and follow one of the guides to reset your setup.
            </p>

            <div className="grid gap-4 mt-8 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <div className="flex w-full flex-col items-center rounded-xl border bg-muted text-card-background py-6 px-4 shadow-sm transition-colors hover:bg-muted/50 sm:p-10 sm:col-span-2 lg:col-span-4">
                ...
                <div className="border rounded-md py-1 px-2 bg-muted flex items-center gap-2">
                  <p>
                    <code className="relative rounded-sm bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm select-none">$</code>
              ...
              <a
                className="flex w-full flex-col items-center justify-center rounded-xl border bg-muted text-card-background py-6 px-4 shadow-sm transition-colors hover:bg-muted/50 sm:p-10 sm:h-52"
                target="_blank"
            ...
            <div className="mt-4">
              <div role="alert" className="relative w-full text-sm rounded-lg border p-4 bg-muted/25 border-border text-foreground">
                <div className="text-sm text-foreground/70 font-normal">
                  <div className="grid gap-2">
                    <div className="flex items-center gap-2 font-medium">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-triangle-alert h-[23px] w-[23px] p-1 flex rounded-sm bg-foreground text-background">
            ...
            <h2 className="font-heading mt-12 scroll-m-20 border-b pb-2 text-2xl tracking-tight first:mt-0" id="troubleshooting">
              <SectionLink id="troubleshooting" /> Troubleshooting
            </h2>
            <p className="leading-7 not-first:mt-6 text-foreground/70">
              If you encounter issues, try deleting your existing{' '}
              <code className="relative rounded-sm bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm">components.json</code>{' '}
              file and follow one of the guides to reset your setup.
            </p>
            <p className="leading-7 not-first:mt-6 text-foreground/70">
