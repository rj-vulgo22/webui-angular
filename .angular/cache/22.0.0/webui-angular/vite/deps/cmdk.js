...
// node_modules/.pnpm/cmdk@1.1.1_@types+react-dom@19.2.3_@types+react@19.2.17__@types+react@19.2.17_react-dom_bc1678d6d5a7ffb92aa41dc7846a5030/node_modules/cmdk/dist/chunk-NZJY6EH4.mjs
var U = 1;
var Y = 0.9;
var H = 0.8;
var J = 0.17;
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node2 = React8.forwardRef((props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(Comp, __spreadProps(__spreadValues({}, primitiveProps), { ref: forwardedRef }));
  });
...
var DismissableLayerBranch = React11.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Primitive.div, __spreadProps(__spreadValues({}, props), { ref: composedRefs }));
});
...
var FocusScope = React12.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Primitive.div, __spreadProps(__spreadValues({ tabIndex: -1 }, scopeProps), { ref: composedRefs, onKeyDown: handleKeyDown }));
});
...
var Portal = React13.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM2.createPortal((0, import_jsx_runtime5.jsx)(Primitive.div, __spreadProps(__spreadValues({}, portalProps), { ref: forwardedRef })), container) : null;
});
...
var DialogOverlay = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime6.jsx)(DialogOverlayImpl, __spreadProps(__spreadValues({}, overlayProps), { ref: forwardedRef })) }) : null;
  }
);
...
var DialogContent = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: context.modal ? (0, import_jsx_runtime6.jsx)(DialogContentModal, __spreadProps(__spreadValues({}, contentProps), { ref: forwardedRef })) : (0, import_jsx_runtime6.jsx)(DialogContentNonModal, __spreadProps(__spreadValues({}, contentProps), { ref: forwardedRef })) });
  }
);
...
var DialogTitle = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime6.jsx)(Primitive.h2, __spreadProps(__spreadValues({ id: context.titleId }, titleProps), { ref: forwardedRef }));
  }
);
...
var DialogDescription = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime6.jsx)(Primitive.p, __spreadProps(__spreadValues({ id: context.descriptionId }, descriptionProps), { ref: forwardedRef }));
  }
);
...
// node_modules/.pnpm/cmdk@1.1.1_@types+react-dom@19.2.3_@types+react@19.2.17__@types+react@19.2.17_react-dom_bc1678d6d5a7ffb92aa41dc7846a5030/node_modules/cmdk/dist/index.mjs
...
var me = t.forwardRef((r, o) => {
  ...
  }), u2 = L(() => /* @__PURE__ */ new Set()), c = L(() => /* @__PURE__ */ new Map()), d = L(() => /* @__PURE__ */ new Map()), f = L(() => /* @__PURE__ */ new Set()), p2 = pe(r), _a = r, { label: b, children: m2, value: R, onValueChange: x, filter: C, shouldFilter: S, loop: A, disablePointerSelection: ge = false, vimBindings: j = true } = _a, O = __objRest(_a, ["label", "children", "value", "onValueChange", "filter", "shouldFilter", "loop", "disablePointerSelection", "vimBindings"]), $2 = useId(), q = useId(), _ = useId(), I = t.useRef(null), v = ke();
  k2(() => {
    if (R !== void 0) {
      let e = R.trim();
  ...
  return t.createElement(Primitive.div, __spreadProps(__spreadValues({ ref: o, tabIndex: -1 }, O), { "cmdk-root": "", onKeyDown: (e) => {
    var s;
...
var he = t.forwardRef((r, o) => {
  ...
  if (!x) return null;
  let _a = r, { disabled: A, value: ge, onSelect: j, forceMount: O, keywords: $2 } = _a, q = __objRest(_a, ["disabled", "value", "onSelect", "forceMount", "keywords"]);
  return t.createElement(Primitive.div, __spreadProps(__spreadValues({ ref: composeRefs(u2, o) }, q), { id: n, "cmdk-item": "", role: "option", "aria-disabled": !!A, "aria-selected": !!R, "data-disabled": !!A, "data-selected": !!R, onPointerMove: A || d.getDisablePointerSelection() ? void 0 : S, onClick: A ? void 0 : C }), r.children);
});
var Ee = t.forwardRef((r, o) => {
  let _a = r, { heading: n, children: u2, forceMount: c } = _a, d = __objRest(_a, ["heading", "children", "forceMount"]), f = useId(), p2 = t.useRef(null), b = t.useRef(null), m2 = useId(), R = K2(), x = P((S) => c || R.filter() === false ? true : S.search ? S.filtered.groups.has(f) : true);
  k2(() => R.group(f), []), ve(f, p2, [r.value, r.heading, b]);
  let C = t.useMemo(() => ({ id: f, forceMount: c }), [c]);
  return t.createElement(Primitive.div, __spreadProps(__spreadValues({ ref: composeRefs(p2, o) }, d), { "cmdk-group": "", role: "presentation", hidden: x ? void 0 : true }), n && t.createElement("div", { ref: b, "cmdk-group-heading": "", "aria-hidden": true, id: m2 }, n), B2(r, (S) => t.createElement("div", { "cmdk-group-items": "", role: "group", "aria-labelledby": n ? m2 : void 0 }, t.createElement(fe.Provider, { value: C }, S))));
});
var ye = t.forwardRef((r, o) => {
  let _a = r, { alwaysRender: n } = _a, u2 = __objRest(_a, ["alwaysRender"]), c = t.useRef(null), d = P((f) => !f.search);
  return !n && !d ? null : t.createElement(Primitive.div, __spreadProps(__spreadValues({ ref: composeRefs(c, o) }, u2), { "cmdk-separator": "", role: "separator" }));
});
var Se = t.forwardRef((r, o) => {
  let _a = r, { onValueChange: n } = _a, u2 = __objRest(_a, ["onValueChange"]), c = r.value != null, d = ee(), f = P((m2) => m2.search), p2 = P((m2) => m2.selectedItemId), b = K2();
  return t.useEffect(() => {
    r.value != null && d.setState("search", r.value);
  }, [r.value]), t.createElement(Primitive.input, __spreadProps(__spreadValues({ ref: o }, u2), { "cmdk-input": "", autoComplete: "off", autoCorrect: "off", spellCheck: false, "aria-autocomplete": "list", role: "combobox", "aria-expanded": true, "aria-controls": b.listId, "aria-labelledby": b.labelId, "aria-activedescendant": p2, id: b.inputId, type: "text", value: c ? r.value : f, onChange: (m2) => {
    c || d.setState("search", m2.target.value), n == null || n(m2.target.value);
  } }));
});
var Ce = t.forwardRef((r, o) => {
  let _a = r, { children: n, label: u2 = "Suggestions" } = _a, c = __objRest(_a, ["children", "label"]), d = t.useRef(null), f = t.useRef(null), p2 = P((m2) => m2.selectedItemId), b = K2();
  return t.useEffect(() => {
  ...
  }, []), t.createElement(Primitive.div, __spreadProps(__spreadValues({ ref: composeRefs(d, o) }, c), { "cmdk-list": "", role: "listbox", tabIndex: -1, "aria-activedescendant": p2, "aria-label": u2, id: b.listId }), B2(r, (m2) => t.createElement("div", { ref: composeRefs(f, b.listInnerRef), "cmdk-list-sizer": "" }, m2)));
});
var xe = t.forwardRef((r, o) => {
  let _a = r, { open: n, onOpenChange: u2, overlayClassName: c, contentClassName: d, container: f } = _a, p2 = __objRest(_a, ["open", "onOpenChange", "overlayClassName", "contentClassName", "container"]);
  return t.createElement(Root, { open: n, onOpenChange: u2 }, t.createElement(Portal2, { container: f }, t.createElement(Overlay, { "cmdk-overlay": "", className: c }), t.createElement(Content, { "aria-label": r.label, "cmdk-dialog": "", className: d }, t.createElement(me, __spreadValues({ ref: o }, p2)))));
});
var Ie = t.forwardRef((r, o) => P((u2) => u2.filtered.count === 0) ? t.createElement(Primitive.div, __spreadProps(__spreadValues({ ref: o }, r), { "cmdk-empty": "", role: "presentation" })) : null);
var Pe = t.forwardRef((r, o) => {
  let _a = r, { progress: n, children: u2, label: c = "Loading..." } = _a, d = __objRest(_a, ["progress", "children", "label"]);
  return t.createElement(Primitive.div, __spreadProps(__spreadValues({ ref: o }, d), { "cmdk-loading": "", role: "progressbar", "aria-valuenow": n, "aria-valuemin": 0, "aria-valuemax": 100, "aria-label": c }), B2(r, (f) => t.createElement("div", { "aria-hidden": true }, f)));
});
